...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <span id="login" class="right"> Logged in
                            as<xsl:text>&#xA0;</xsl:text><b><xsl:value-of select="$name"
                        /></b><xsl:text>&#xA0;</xsl:text>(<a href="/bjx/logout">logout</a>) </span>
                                        ...
                                        <tbody>
                                            <xsl:for-each select="games/game">
                                                <tr>
                                                  ...
                                                  <td>
                                                  <form action="/bjx/games/{@id}/delete"
                                                  method="post">
                                    ...
                                    <table id="highscores-table" class="table">
                                        ...
                                        <tbody>
                                            <xsl:for-each select="games/game/player">
                                                ...
                                                <tr>
                                                  <td>
                                                  <xsl:value-of select="@name"/> (Game <xsl:value-of
                                                  select="../@id"/>) </td>
                                                  <td>
